...
export default function PortfolioPage({
  ...
  const handleOpenDocFromChat = async (docTitle) => {
    try {
      ...
      // Find match - handling potential Input_Documents/ prefix in the ID
      ...
      if (match) {
        setChatPreviewDoc({
          // Use the full document_id (e.g., Input_Documents/Building/file.pdf)
          ...
          size: match.size || "N/A",
          isLocal: false,
          // Use the SAS URL generated by the backend
          previewUrl:
            match.previewUrl ||
